...
for i in num_classes:
	...
	#classifier.summary()
	classifier1 = createNN_1layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.1,  optimizer_type=SGD, momentum = 0.8)[0]
	model1 = createNN_1layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.1, optimizer_type=SGD, momentum = 0.8)[1:]

	classifier2 = createNN_1layer(hidden_units=70, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_uniform', bias='zeros',	learning_rate = 0.001, optimizer_type=Adam)[0]
	model2 = createNN_1layer(hidden_units=70, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_uniform', bias='zeros', learning_rate = 0.001, optimizer_type=Adam)[1:]

	classifier3 = createNN_1layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.02, optimizer_type=SGD, momentum = 0.9)[0]
	model3 = createNN_1layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.02, optimizer_type=SGD, momentum = 0.9)[1:]

	classifier4 = createNN_2layer(hidden_units=70, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.01, optimizer_type=Adam)[0]
	model4 = createNN_2layer(hidden_units=70, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.01, optimizer_type=Adam)[1:]

	classifier5 = createNN_2layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.0001, optimizer_type=Adam)[0]
	model5 = createNN_2layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.0001, optimizer_type=Adam)[1:]

	classifier6 = createNN_2layer(hidden_units=50, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='ones',	learning_rate = 0.03, optimizer_type=Adam)[0]
	model6 = createNN_2layer(hidden_units=50, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='ones', learning_rate = 0.03, optimizer_type=Adam)[1:]

	classifier7 = createNN_2layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.001, optimizer_type=Adamax)[0]
	model7 = createNN_2layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.001, optimizer_type=Adamax)[1:]

	classifier8 = createNN_3layer(hidden_units=200, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.001, optimizer_type=SGD, momentum = 0.95)[0]
	model8 = createNN_3layer(hidden_units=200, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.001, optimizer_type=SGD, momentum=0.95)[1:]

	classifier9 = createNN_3layer(hidden_units=40, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.015, optimizer_type=SGD, momentum=0.7)[0]
	model9 = createNN_3layer(hidden_units=40, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.015, optimizer_type=SGD, momentum=0.7)[1:]

	classifier10 = createNN_3layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros',	learning_rate = 0.01, optimizer_type=SGD, momentum=0.9)[0]
	model10 = createNN_3layer(hidden_units=100, output_dim=i, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.01, optimizer_type=SGD, momentum=0.9)[1:]
